  ...
  return (
    <>
      ...
      <section className="container-app max-w-3xl space-y-4 py-14 text-sm leading-relaxed text-muted md:text-base">
        <p>
          Assignment Solution aims for fair resolution when work cannot proceed or delivery fails under confirmed
          terms.
        </p>
        ...
        <p>Email hello@assignmentsolution.com with your order ID to start a refund review.</p>
      </section>
    </>
  );
}
