...
export default function NotFoundPage() {
  return (
    <>
      <Seo title="Page Not Found" description="The page you requested does not exist on Scholarly Desk." />
      <section className="container-app flex min-h-[50vh] flex-col items-center justify-center py-20 text-center">
        ...
        <p className="mt-3 max-w-md text-muted">
          That route is not part of Scholarly Desk. Head home or browse services to continue.
        </p>
